...
<meta name="keywords" content="md6 hash generator, md6, md6 hash, md6 generator">
<title>MD6 Hash Generator</title>
...
if(isset($_POST['md6me'])) {
$data = ($_POST['md6me']);
$result = $md6->hex($data);
echo "Output Hash Size: 256<br><br>";
}
?>
 
Please input text to be encrypted to MD6<br /><br />
<form action="" method="post">
    <label for="md5me"></label>
    md6 ( <input name="md6me" id="md6me" type="text" /> ) <small>Hash Size: 256</small><br />
    <input type="submit" class="button" value="Create MD6 Hash" />
</form>
<p>MD6 checksum (value) -> <strong><?php echo $result;?></strong></p>
<br />
What is MD6?<br />
<a href="https://en.wikipedia.org/wiki/MD6" target="_blank">Wikipedia.org/wiki/MD6</a>
