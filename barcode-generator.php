...
<meta name="description" content="Online Barcode Generator">
<meta name="keywords" content="barcode generator, online barcode, online barcode generator, barcode creator, 1d 2d barcode maker, barcode maker, barcode">
...
<form action="#" method="get">
	<table class="noborder">
		<tbody>
			<tr>
				<td>Type:</td>
				<td id="barcode-type-container">
					<input type="radio" name="type" id="code128" checked="checked"/><label for="code128">Code 128 <small>(all ASCII characters)</small></label><br/>
					<input type="radio" name="type" id="code93"/><label for="code93">Code 93 <small>(all ASCII characters)</small></label><br/>
					<input type="radio" name="type" id="code39"/><label for="code39">Code 39 <small>(uppercase, space, .-+/$%)</small></label><br/>
					<input type="radio" name="type" id="codabar"/><label for="codabar">Codabar <small>(numbers, .:-+/$)</small></label><br/>
					<input type="radio" name="type" id="interleaved2Of5"/><label for="interleaved2Of5">Interleaved 2 of 5 <small>(digits only, even length)</small></label><br/>
					<input type="radio" name="type" id="upcARaw"/><label for="upcARaw">UPC-A, raw <small>(12 numbers)</small></label><br/>
					<input type="radio" name="type" id="upcACheck"/><label for="upcACheck">UPC-A, auto check digit <small>(11 numbers)</small></label><br/>
					<input type="radio" name="type" id="ean13Raw"/><label for="ean13Raw">EAN-13, raw <small>(13 numbers)</small></label><br/>
					<input type="radio" name="type" id="ean13Check"/><label for="ean13Check">EAN-13, auto check digit <small>(12 numbers)</small></label><br/>
					<input type="radio" name="type" id="ean8Raw"/><label for="ean8Raw">EAN-8, raw <small>(8 numbers)</small></label><br/>
					<input type="radio" name="type" id="ean8Check"/><label for="ean8Check">EAN-8, auto check digit <small>(7 numbers)</small></label>
				</td>
			</tr>
			<tr>
				<td><label for="text">Text:</label></td>
				<td><input type="text" id="text" maxlength="300" size="40" style="width:20em"/></td>
			</tr>
			<tr>
				<td><label for="bar-width">Bar width:</label></td>
				<td><input type="number" value="3" min="1" max="30" id="bar-width" style="width:4em"/> pixels</td>
			</tr>
			<tr>
				<td><label for="bar-height">Bar height:</label></td>
				<td><input type="number" value="200" min="1" max="1000" id="bar-height" style="width:4em"/> pixels</td>
			</tr>
			<tr>
				<td><label for="padding">Padding:</label></td>
				<td><input type="number" value="40" min="0" max="1000" id="padding" style="width:4em"/> pixels</td>
			</tr>
			<tr>
				<td>Feedback:</td>
				<td id="feedback"></td>
			...
			<tr>
				<td></td>
				<td><input type="submit" class="button" value="Generate"/></td>
			</tr>
			<tr>
				<td>Barcode:</td>
				<td><canvas width="185" height="280" style="display:block; border:1px solid #A0A0A0"></canvas></td>
			</tr>
		</tbody>
	</table>
</form>
