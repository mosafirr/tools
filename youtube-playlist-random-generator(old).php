...
<textarea onclick="this.select()" readonly rows="10" cols="53"><iframe allowfullscreen="allowFullScreen" src="https://www.youtube.com/embed/videoseries?list='.clean_url($id).'&amp;autoplay=1&index=<?php print rand(1,'.$count.')?>" allowtransparency="true" width="'.$width.'" height="'.$height.'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture allowfullscreen"></iframe></textarea>';
?>

<br><br>Preview:<br>
<iframe allowfullscreen="allowFullScreen" src="https://www.youtube.com/embed/videoseries?list=<?php echo (clean_url($id)); ?>&amp;autoplay=1&index=<?php print rand(1,$count)?>" allowtransparency="true" width="<?php echo $width; ?>" height="<?php echo $height; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture allowfullscreen"></iframe>
