...
function ResetUrls() { $("#txtUrls").val(""), $("#txtUrls").focus() } function OpenURLs() { $("#message").text(""); var t, e = $("#txtUrls").val(), n = [" ", "\n", ","]; if (t = e.split(new RegExp(n.join("|"), "g")), t.length > 0) var r = OpenUrl(t[0]); for (var l = 1; l < t.length; l++) { var s = OpenUrl(t[l]); if (null == s || "undefined" == typeof s) { $("#message").text("By default popup is blocked, Please allow pop-up to this site unless it will not work."), r.close(); break } } } function OpenUrl(t) { var e; return t = ltrim(t), t = rtrim(t), null != t && t.length > 0 ? (-1 == t.indexOf("http://") && -1 == t.indexOf("https://") && (t = "http://" + t), -1 != t.indexOf(" ") && (t = t.substring(0, t.indexOf(" "))), e = window.open(t, "")) : e = "invalid url", e } function ltrim(t) { return t.replace(/^\s+/, "") } function rtrim(t) { return t.replace(/\s+$/, "") } $(document).ready(function () { $("#openUrls").click(function () { OpenURLs() }), shortcut.add("ctrl+enter", function () { OpenURLs() }), $("#resetUrls").click(function () { ResetUrls() }), shortcut.add("ctrl+r", function () { ResetUrls() }) });
