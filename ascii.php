...
<meta name="description" content="Online ASCII Generator - Text to ASCII">
<meta name="keywords" content="ascii, ascii text generator, text to ascii, text2ascii, text to ascii generator, ascii art generator">
<title>ASCII Text Generator</title>
...
<BR>
<TABLE CELLPADDING=0>
Text: <INPUT TYPE=TEXT NAME="inputField"> &nbsp;&nbsp;&nbsp;
Style: <SELECT NAME="textStyle">
<OPTION SELECTED>1 style
<OPTION>2 style
</SELECT> &nbsp;&nbsp;&nbsp;<br />
</TABLE>
<br>
<SPAN ID=windowMarker>Output:<BR>
<TEXTAREA readonly NAME="outputField" style="width: 500px;height: 200px;" WRAP=OFF></TEXTAREA><br>
<button TYPE=BUTTON class="button" onclick="beginGenerator()">Generate</button>
</form>
<br />
