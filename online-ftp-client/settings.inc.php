...
$net2ftp_settings["email_feedback"] = "eti@localhost";
...
$net2ftp_settings["message_browse"] = "ETI Free Stuff 1998-2013";
...
$net2ftp_settings["log_length_months"] = 1; // number of months
...
$net2ftp_settings["max_filesize"]  = "20971520";  // in Bytes, default 10 MB
...
$net2ftp_settings["max_consumption_ipaddress_datatransfer"] = 104857600; // per IP address
$net2ftp_settings["max_consumption_ftpserver_datatransfer"] = 104857600; // per FTP server

// Maximum script execution time per day (in seconds)
$net2ftp_settings["max_consumption_ipaddress_executiontime"] = 1600; // per IP address
$net2ftp_settings["max_consumption_ftpserver_executiontime"] = 1600; // per FTP server
